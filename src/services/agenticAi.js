...
TASK: Analyze if the user's intention is about Handit or any topic covered in the DOCUMENTATION CONTEXT.

DECISION RULES:

1.- translate the user's message and the conversation history to english.
2.- GO THROUGH THE DOCUMENTATION CONTEXT AND CHECK IF THE USER LAST INTENTION IS ABOUT Handit or any topic covered in the DOCUMENTATION CONTEXT.
3.- If the user's last intention is about Handit or any topic covered in the DOCUMENTATION CONTEXT → Return handit: true
4.- If the user's current message is about Handit but not mentioned directly, like <i want to install it>, or something about AI or Engineering → Return handit: true
...
Generate ONLY the response text (no JSON, no quotes).`;
    ...
    async orientIntention(userMessage, conversationHistory, intentionResult) {
        try {
            ...
            const orientPrompt = `You are an Orient Intention LLM. Your goal is to determine if the user wants to start or is in the process of configuring Phase 1: AI Observability, or has a general inquiry about Handit.ai.
...
Phase 1: AI Observability PROCESS DEFINITION:
The onboarding process include the first phase:

Phase 1: AI Observability
Set up comprehensive tracing to see inside your AI agents and understand what they're doing

TASK: Analyze the CURRENT USER MESSAGE to determine what user wants:

1. Go through the HANDIT.AI CONTEXT

2. Is the user in or wants to start the Phase 1: AI Observability? 
   ...
   - WANTING to start configuring the Phase 1: AI Observability
   - wanting to install the Phase 1: AI Observability
   - asking how to start the process of configuring handit
...
3. Is this a GENERAL INQUIRY about Handit.ai?
   ...
   - asking about Quality Evaluation 
   - asking about Self-Improving AI
   - asking about phase 2: Quality Evaluation
   - asking about phase 3: Self-Improving AI
...
Generate ONLY the response text (no JSON, no quotes).`;
    ...
    async generalKnowledge(userMessage, conversationHistory) {
        try {
            ...
            const generalPrompt = `You are a General Knowledge LLM for Handit.ai. Your goal is to provide comprehensive and helpful answers about Handit.ai topics for users who have inquiries.
...
1. GO THROUGH THE ENTIRE HANDIT.AI DOCUMENTATION CONTEXT THOROUGHLY
2. CHECK THE {CONVERSATION_HISTORY} to get more context and Response the user last meesage: ${userMessage}. Be direct and accurate information but all based on HANDIT.AI DOCUMENTATION CONTEXT
3. Stay STRICTLY within Handit.ai topics - don't answer questions outside this scope
4. Respond in the SAME LANGUAGE as the user's last message: ${userMessage}
5. Keep key terms like "AI Observability", "Quality Evaluation", "Self-Improving AI", "Handit.ai" in English, and all keywords about Handit.ai in English
...
- Respond in the SAME LANGUAGE as the user last message: ${userMessage}
